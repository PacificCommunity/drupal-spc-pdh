        ...
        //start context
            ...
            function setCartBars(svg, data,  x, y, width, height, tooltip, tooltext, attrX, attrY, attrH, typY, id ){
                svg.selectAll(".bar")
                    ...
                    .attr("ry", 10)
                    .attr("x", attrX)            
                    .attr("y", function(data) { return y(0); })
                    .attr("height", function(data) { return height - y(0); })
            ...
            function setSvgGenderBarData(svg, data, x0, x1, y, width, height, tooltip, tooltext, boyWrap){
                ...
                slice.selectAll("rect")
                    ...
                    .style("fill", function(d) {if (d.rate == 'M' || d.rate == 'T'){return setFill(d.value);}return '#fff';})
            ...
            if ($('.chart-13').length){
                ...
                setSvgGenderBarData(svg, chart13primary, x0, x1, y, width, height, tooltip, tooltext, boyWrap);
